...
export const experience: Experience[] = [
  {
    ...
    bullets: [
      "Delivered frontend development for ADCP as an individual contributor using ReactJS, Redux, TypeScript, GraphQL, AG Grid, and Tailwind CSS, automating App Data service management for Walmart's platform.",
      "Built a reusable, modular component library that boosted maintainability and accelerated sprint delivery; contributed high-quality code through regular peer code reviews.",
  ...
  },
  {
    ...
    project: "Smart Communication Platform",
    bullets: [
      ...
      "Served as Frontend Lead: mentored 13 developers, drove coding standards, and led technical design reviews.",
