...
export const projects: Project[] = [
  {
    ...
    desc: "Contributed as an individual contributor to ADCP using React, Redux, TypeScript, GraphQL, AG Grid & Tailwind CSS to automate app data services for Walmart's platform.",
    tags: [
      "React",
      "TypeScript",
      "GraphQL",
    ...
    tech: {
      frontend: "React, TypeScript, AG Grid, Tailwind CSS",
  ...
  },
  {
    ...
    desc: "Led frontend development as Frontend Lead for a communication platform handling Email, SMS & Push notifications for millions of daily Walmart transactions.",
    ...
    metrics: [
      ...
      { v: "13", l: "Developers Mentored" },
      { v: "99.8%", l: "Uptime" },
      { v: "40%", l: "Less Duplication" },
    ],
    tech: {
    ...
    impact:
      "Serving millions of daily users with 99.8% uptime while mentoring 13 developers as Frontend Lead.",
  },
  {
    id: "clear",
