export interface Project {
  ...
  tech: { frontend: string; backend: string; database: string; testing: string };
  features: string[];
  challenge: string;
  solution: string;
  impact: string;
...
export const projects: Project[] = [
  {
    ...
    tags: ['React', 'TypeScript', 'GraphQL', 'AD Grid', 'Node.js', 'MongoDB', 'Tailwind CSS'],
    ...
    challenge: 'The existing app data management process was manual and error-prone, leading to delays and reduced visibility for the team.',
    solution: 'Developed a real-time dashboard with GraphQL API, role-based access control, and a reusable component library that reduced development time by 40%.',
    impact: 'The platform achieved 99.9% reliability, 40% faster development cycles, and improved maintainability by 30%.',
  },
  {
    id: 'scp',
    client: 'Walmart Global Tech',
    ...
    challenge: 'Building a reliable communication platform capable of serving millions of users across multiple channels simultaneously.',
    solution: 'Architected a scalable notification system with event-driven microservices handling Email, SMS & Push with high availability.',
    impact: 'Serving millions of daily users with 99.8% uptime across 3 unified channels.',
  },
  {
    id: 'clear',
    ...
    challenge: 'Replacing a legacy Line-of-Business system with a modern, responsive web application.',
    solution: 'Built a custom responsive web app using AngularJS with a rich UI and tight integration with existing business APIs.',
    impact: 'Successfully replaced the legacy system with 60% faster load times and significantly improved user adoption.',
  },
  {
    id: 'astra',
    client: 'Born Group',
    ...
    challenge: 'Developing customer-facing web features for a large automotive company in Indonesia.',
    solution: 'Delivered vehicle reservation, test drive scheduling and service booking features with a clean, responsive UI.',
    impact: 'Improved booking conversions by 30% with a 4.8-star user rating and 98% uptime.',
  },
  {
    id: 'amex',
    ...
    challenge: 'Delivering accessible, high-performance banking features for millions of American Express customers.',
    solution: 'Built WCAG 2.1 compliant React components with thorough testing coverage and performance optimization.',
    impact: 'Achieved 98% test coverage and A+ accessibility rating serving millions of users.',
  },
];

export const projectFilters = ['All', 'Walmart Global Tech', 'American Enterprises', 'Other Clients', 'React', 'Full Stack'];
